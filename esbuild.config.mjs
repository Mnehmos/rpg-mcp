...
async function build() {
    ...
    try {
        ...
        console.log('     copy bin\\better_sqlite3-win.node ..\\src-tauri\\binaries\\better_sqlite3.node');
        console.log('');
        ...
        console.log('');
        console.log('   Note: Paths assume src-tauri is in a sibling directory (e.g., Quest Keeper AI frontend).');
        console.log('   Create the binaries directory if it doesn\'t exist: mkdir -p ../src-tauri/binaries');
        console.log('');
